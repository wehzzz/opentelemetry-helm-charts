...
{{- $_ := set $collector "config" $config }}
{{- end }}
{{- if (dig "presets" "profiling" "enabled" false .collector) }}
...
{{- end }}
{{- $podAssoc := (index $config.processors $processorName).pod_association }}
...
{{- $_ := set (index $config.processors $processorName) "pod_association" (prepend $podAssoc $containerIdSource) }}
{{- end }}
{{- end }}
{{- $config | toYaml }}
{{- end }}
...
receivers:
  {{ .receiverName }}:
    ...
    {{- end }}
    objects:
{{- if (dig "core" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "rbac" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "storage" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "networking" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "autoscaling" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "policy" "enabled" false $preset) }}
...
{{- end }}
{{- end }}
{{- if (dig "apiExtensions" "enabled" false $preset) }}
